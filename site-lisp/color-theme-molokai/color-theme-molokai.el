...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (font-lock-comment-face ((t (:foreground "#7FBF3F" :slant italic))))
     (font-lock-comment-delimiter-face ((t (:foreground "#7FBF3F" :slant italic))))
     ...
     (lazy-highlight ((t (:foreground "#7FBF3F" :background "#000000"))))
     ...
     (markdown-comment-face ((t (:foreground "#7FBF3F"))))
